...
Public Class FrmNivel3
    ...
    Private Sub FrmNivel3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        CarregarNivelAcesso()
    End Sub
    ...
    Sub AtualizarNivelAcesso()
        ...
        For Each chk In GboxNivel1.Controls
            ...
            sql = "Update controle_acesso Set nivel3 = Case rotina When '" & nome & "' then '" & status & "' end where rotina In ('" & nome & "')"
    ...
    Private Sub FrmNivel3_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed
