...
Public Class FrmNivel2
    ...
    Private Sub FrmNivel2_FormClosed(sender As Object, e As FormClosedEventArgs) Handles MyBase.FormClosed

        If MsgBox("Deseja salvar alterações?", vbYesNo, "Nivel Acesso 2") = vbYes Then
            AtualizarNivelAcesso()
        End If
    End Sub

    Private Sub FrmNivel2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        CarregarNivelAcesso()
    End Sub
    ...
    Sub AtualizarNivelAcesso()
        ...
        For Each chk In GboxNivel1.Controls
            ...
            sql = "Update controle_acesso Set nivel2 = Case rotina When '" & nome & "' then '" & status & "' end where rotina In ('" & nome & "')"
